...
boxplot of % of non-contaminant species reads for k2 taxa NOT mapped to the human pangenome, by body site

```{r}

mgx_k2_non_hupan_boxplot <- ggplot(mgx_k2_species_QC, 
                                   aes(x=region, 
                                       y=percent_not_mapped_to_hupan, 
