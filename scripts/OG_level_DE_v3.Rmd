...
Which pathways were statistically enriched in both clr-Maaslin2 and DESEq2?
...
differentially enriched between cheek (n=22) and volar forearm (n=18) metatranscriptomes. (Panel B) Same as (A)
...
#only one enriched term for GO:MF here 
Ch_vs_Vf_bact_GO_MF_GSEA <- site_DE_res_enrichments_GO_MF_GSEA$Ch_vs_Vf$bact_DESeq_GSEA_results@result

#only two enriched terms here
Ch_vs_Vf_fungi_GO_MF_GSEA <- site_DE_res_enrichments_GO_MF_GSEA$Ch_vs_Vf$fungi_DESeq_GSEA_results@result

#25 enriched terms here
Ch_vs_Vf_bact_GO_BP_GSEA <- site_DE_res_enrichments_GO_BP_GSEA$Ch_vs_Vf$bact_DESeq_GSEA_results@result

#71 enriched terms here
Ch_vs_Vf_fungi_GO_BP_GSEA <- site_DE_res_enrichments_GO_BP_GSEA$Ch_vs_Vf$fungi_DESeq_GSEA_results@result

#################
###GO Slimming###
#################
Ch_vs_Vf_bact_GO_MF_GSEA_slim <- associate_GO_to_slim(Ch_vs_Vf_bact_GO_MF_GSEA$ID, mode="MF")

Ch_vs_Vf_bact_GO_MF_GSEA_fmt <- prepare_NES_plot_input(df=Ch_vs_Vf_bact_GO_MF_GSEA,
                                                               slimdf=Ch_vs_Vf_bact_GO_MF_GSEA_slim,
                                                               chosen_parent_ids = "nucleic acid binding")

Ch_vs_Vf_bact_GO_MF_GSEA_NES_condensed_df <- Ch_vs_Vf_bact_GO_MF_GSEA_fmt %>% dplyr::select(Description, NES, GO_slim_parent_term)

Ch_vs_Vf_bact_GO_MF_GSEA_NES_condensed_df$organism <- "Bacteria"
Ch_vs_Vf_bact_GO_MF_GSEA_NES_condensed_df$GO_level <- "Molecular function"

#

Ch_vs_Vf_fungi_GO_MF_GSEA_slim <- associate_GO_to_slim(Ch_vs_Vf_fungi_GO_MF_GSEA$ID, mode="MF")

Ch_vs_Vf_fungi_GO_MF_GSEA_fmt <- prepare_NES_plot_input(df=Ch_vs_Vf_fungi_GO_MF_GSEA,
                                                               slimdf=Ch_vs_Vf_fungi_GO_MF_GSEA_slim,
                                                               chosen_parent_ids = c("nucleic acid binding",
                                                                                     "antioxidant activity"))

Ch_vs_Vf_fungi_GO_MF_GSEA_NES_condensed_df <- Ch_vs_Vf_fungi_GO_MF_GSEA_fmt %>% dplyr::select(Description, NES, GO_slim_parent_term)


Ch_vs_Vf_fungi_GO_MF_GSEA_NES_condensed_df$organism <- "Fungi"
Ch_vs_Vf_fungi_GO_MF_GSEA_NES_condensed_df$GO_level <- "Molecular function"


#

Ch_vs_Vf_bact_GO_BP_GSEA_slim <- associate_GO_to_slim(Ch_vs_Vf_bact_GO_BP_GSEA$ID, mode="BP")

Ch_vs_Vf_bact_GO_BP_GSEA_fmt <- prepare_NES_plot_input(df=Ch_vs_Vf_bact_GO_BP_GSEA,
...
Ch_vs_Vf_bact_GO_BP_GSEA_NES_condensed_df$organism <- "Bacteria"
Ch_vs_Vf_bact_GO_BP_GSEA_NES_condensed_df$GO_level <- "Biological process"

#

Ch_vs_Vf_fungi_GO_BP_GSEA_slim <- associate_GO_to_slim(Ch_vs_Vf_fungi_GO_BP_GSEA$ID, mode="BP")

Ch_vs_Vf_fungi_GO_BP_GSEA_fmt <- prepare_NES_plot_input(df=Ch_vs_Vf_fungi_GO_BP_GSEA,
...
Ch_vs_Vf_fungi_GO_BP_GSEA_NES_condensed_df <- Ch_vs_Vf_fungi_GO_BP_GSEA_fmt %>%
                                                                              dplyr::filter(Description %in% 
                                                                                              c("antibiotic catabolic process",
                                                                                            "cellular oxidant detoxification",
                                                                                            "proton motive force-driven ATP synthesis",
                                                                                            "protein modification process",
"aromatic compound biosynthetic process",
"mitotic cell cycle","cellular response to nutrient levels")) %>% dplyr::select(Description, NES, GO_slim_parent_term)


Ch_vs_Vf_fungi_GO_BP_GSEA_NES_condensed_df$organism <- "Fungi"
Ch_vs_Vf_fungi_GO_BP_GSEA_NES_condensed_df$GO_level <- "Biological process"
...
Ch_vs_Vf_all_GO_GSEA_NES_condensed_df$direction <- ifelse(Ch_vs_Vf_all_GO_GSEA_NES_condensed_df$NES >0,
                                                          "enriched_in_Ch", "enriched_in_Vf")



Ch_vs_Vf_all_GO_GSEA_NES_condensed_plot <- ggplot(Ch_vs_Vf_all_GO_GSEA_NES_condensed_df, aes(x=Description, y=NES, fill = direction)) +
